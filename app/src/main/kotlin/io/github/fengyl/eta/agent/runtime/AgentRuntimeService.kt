...
import io.github.fengyl.eta.agent.overlay.AgentOverlayBubble
import io.github.fengyl.eta.agent.overlay.AgentOverlayGlow
import io.github.fengyl.eta.agent.overlay.AgentOverlayOrb
import io.github.fengyl.eta.agent.overlay.AgentResultCard
import io.github.fengyl.eta.agent.overlay.AgentOverlayPhase
import io.github.fengyl.eta.agent.overlay.AgentOverlayState
import io.github.fengyl.eta.agent.overlay.AgentOverlayStatus
import io.github.fengyl.eta.agent.overlay.AgentOverlayVisibilityPolicy
import io.github.fengyl.eta.agent.overlay.applyEvent
import io.github.fengyl.eta.config.Prefs
import io.github.fengyl.eta.core.AndroidAgentLogger
import io.github.fengyl.eta.core.ModuleConfig
...
internal class AgentRuntimeService : Service(), LifecycleOwner, SavedStateRegistryOwner {
                        ...
                        startRun(
                            request.copy(
                                ...
                                isolatedDisplay = request.isolatedDisplay ||
                                    io.github.fengyl.eta.agent.display.DisplaySessionStore.enabled(this),
                            ),
                            replyTo,
                        )
                    },
    ...
    private companion object {
        const val ACTION_KEEP_ALIVE = "io.github.fengyl.eta.agent.runtime.KEEP_ALIVE"
