...
internal object AccessibilityProtectionProtocol {
    ...
    const val ACTION_SET =
        "io.github.fengyl.eta.action.SET_ACCESSIBILITY_PROTECTION"
    const val ACTION_RECOVER =
        "io.github.fengyl.eta.action.RECOVER_ACCESSIBILITY_SERVICE"
    const val PERMISSION =
        "io.github.fengyl.eta.permission.CONTROL_ACCESSIBILITY_PROTECTION"
    ...
    const val HEALTH_AUTHORITY = "io.github.fengyl.eta.accessibility.health"
