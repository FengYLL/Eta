package io.github.fengyl.eta.agent.tool
...
import io.github.fengyl.eta.agent.browser.AgentBrowserSession
import io.github.fengyl.eta.agent.device.DeviceControlUnavailableException
import io.github.fengyl.eta.agent.device.RootAccess
import io.github.fengyl.eta.agent.device.RootShellDeviceController
...
import io.github.fengyl.eta.agent.model.AgentScreenObservationContract
import io.github.fengyl.eta.agent.model.AgentSensitiveToolPolicy
import io.github.fengyl.eta.agent.overlay.AgentHapticFeedback
import io.github.fengyl.eta.agent.overlay.GestureIndicator
import io.github.fengyl.eta.agent.runtime.AgentAppContext
import io.github.fengyl.eta.agent.skill.SkillCompatibilityChecker
import io.github.fengyl.eta.agent.skill.SkillIndexService
import io.github.fengyl.eta.agent.skill.SkillInstallErrorCode
import io.github.fengyl.eta.agent.skill.SkillInstallResult
import io.github.fengyl.eta.agent.skill.SkillLoader
import io.github.fengyl.eta.agent.skill.SkillPackageInstaller
import io.github.fengyl.eta.agent.skill.SkillParser
import io.github.fengyl.eta.agent.skill.SkillResourceReader
import io.github.fengyl.eta.agent.skill.SkillResourceReadResult
import io.github.fengyl.eta.agent.skill.GitHubSkillRepositoryParser
import io.github.fengyl.eta.agent.skill.GitHubSkillInspection
import io.github.fengyl.eta.agent.skill.GitHubSkillRepository
import io.github.fengyl.eta.agent.skill.GitHubSkillSourceException
import io.github.fengyl.eta.agent.skill.PublicGitHubSkillSource
import io.github.fengyl.eta.agent.terminal.AlpineEnvironmentPaths
...
import io.github.fengyl.eta.agent.terminal.RootShellTerminalController
import io.github.fengyl.eta.agent.terminal.SharedFolderMounts
import io.github.fengyl.eta.config.Prefs
import io.github.fengyl.eta.core.AgentLogger
import io.github.fengyl.eta.core.HookSupport
import io.github.fengyl.eta.data.repository.AgentMemoryException
import io.github.fengyl.eta.data.repository.AgentMemoryMutation
import io.github.fengyl.eta.data.repository.AgentMemoryRepository
import io.github.fengyl.eta.data.repository.AgentMemoryWriteResult
...
internal class AgentLocalTools(
    ...
    private fun inspectionResult(
        inspection: io.github.fengyl.eta.agent.skill.GitHubSkillInspection,
    ): String {
