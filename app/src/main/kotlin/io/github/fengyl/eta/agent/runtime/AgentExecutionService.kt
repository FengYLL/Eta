...
internal class AgentExecutionService : Service() {
    ...
    private fun notification(): Notification {
        ...
        if (displayResources.count() > 0) {
            val workDisplay = PendingIntent.getActivity(this, 2,
                Intent(this, io.github.fengyl.eta.agent.display.WorkDisplayActivity::class.java),
                PendingIntent.FLAG_UPDATE_CURRENT or PendingIntent.FLAG_IMMUTABLE)
            builder.setContentText(getString(R.string.work_display_title) + " · " +
                io.github.fengyl.eta.agent.display.DisplaySessionStore.state.value.reason)
    ...
    companion object {
        ...
        private const val ACTION_STOP = "io.github.fengyl.eta.action.STOP_USER_EXECUTION"
