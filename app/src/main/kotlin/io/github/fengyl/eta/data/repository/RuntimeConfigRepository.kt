...
import io.github.fengyl.eta.data.model.OpenAiCompatibleProviderSetting
...
import io.github.fengyl.eta.data.model.runtimeProviderType
import io.github.fengyl.eta.data.model.selectedOrFirstModel
import io.github.fengyl.eta.data.provider.BuiltinProviders
import io.github.fengyl.eta.data.provider.ProviderSourceRegistry
import io.github.fengyl.eta.data.provider.ReasoningCapabilityResolver
...
internal object RuntimeConfigRepository {
    ...
    fun buildRuntimeConfig(provider: ProviderSetting, model: Model): AgentModelClient.ModelConfig {
        ...
        val inferOpenAiCatalog = sourceType == io.github.fengyl.eta.data.model.ProviderSourceTypes.CUSTOM &&
        ...
        val reasoningCapabilities = ReasoningCapabilityResolver.resolve(
            sourceType = if (inferOpenAiCatalog) {
                io.github.fengyl.eta.data.model.ProviderSourceTypes.OPENAI
            } else {
                sourceType
            },
            model = model,
