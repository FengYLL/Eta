...
import io.github.fengyl.eta.agent.model.AgentContextSnapshot
...
import io.github.fengyl.eta.EtaApp
import io.github.fengyl.eta.R
import io.github.fengyl.eta.agent.accessibility.AgentAccessibilityService
import io.github.fengyl.eta.agent.device.AgentFileReferenceGateway
import io.github.fengyl.eta.agent.device.DeviceLocationProvider
import io.github.fengyl.eta.agent.device.RootAccess
import io.github.fengyl.eta.agent.media.AgentImageCodec
import io.github.fengyl.eta.agent.memory.AgentMemoryContextBuilder
import io.github.fengyl.eta.agent.model.AgentFileReference
import io.github.fengyl.eta.agent.model.AgentFileReferenceKind
import io.github.fengyl.eta.agent.model.AgentFileReferencePolicy
import io.github.fengyl.eta.agent.model.AgentFileReferencePromptCodec
import io.github.fengyl.eta.agent.model.AgentModelClient
import io.github.fengyl.eta.agent.roleplay.RoleplayBinding
import io.github.fengyl.eta.agent.roleplay.CharacterMacros
import io.github.fengyl.eta.agent.roleplay.CharacterCardCodec
import io.github.fengyl.eta.agent.roleplay.RoleplayMessageLink
import io.github.fengyl.eta.agent.roleplay.RoleplayMessageState
import io.github.fengyl.eta.data.repository.CharacterRepository
import io.github.fengyl.eta.agent.runtime.AgentEvent
import io.github.fengyl.eta.agent.runtime.AgentExecutionService
import io.github.fengyl.eta.agent.runtime.AgentExternalArchivePayload
import io.github.fengyl.eta.agent.runtime.AgentRunArchiveStore
import io.github.fengyl.eta.agent.runtime.AgentRunCheckpointStore
import io.github.fengyl.eta.agent.runtime.AgentRuntimeClient
import io.github.fengyl.eta.agent.runtime.AgentRuntimeWire
import io.github.fengyl.eta.agent.runtime.AgentTokenUsage
import io.github.fengyl.eta.agent.runtime.AgentUiHandoffPayload
import io.github.fengyl.eta.agent.skill.SkillRuntime
import io.github.fengyl.eta.config.Prefs
import io.github.fengyl.eta.core.AndroidAgentLogger
import io.github.fengyl.eta.core.safeLogType
import io.github.fengyl.eta.data.model.ModelReasoningCapabilities
import io.github.fengyl.eta.data.model.ReasoningEffort
import io.github.fengyl.eta.data.repository.AgentMemoryRepository
import io.github.fengyl.eta.data.repository.EtaBackupRepository
import io.github.fengyl.eta.data.repository.EtaBackupSummary
import io.github.fengyl.eta.data.repository.ProviderRepository
import io.github.fengyl.eta.data.repository.RuntimeConfigRepository
import io.github.fengyl.eta.ui.model.AgentChatHomeUiState
import io.github.fengyl.eta.ui.model.AgentChatMessageUi
import io.github.fengyl.eta.ui.model.AgentMemoryUiState
import io.github.fengyl.eta.ui.model.AgentMessageUi
import io.github.fengyl.eta.ui.model.AgentModelPickerProjector
import io.github.fengyl.eta.ui.model.AgentModelPickerUiState
import io.github.fengyl.eta.ui.model.AgentSkillsUiState
import io.github.fengyl.eta.ui.model.AgentToolsUiState
import io.github.fengyl.eta.ui.model.ConversationModeUi
import io.github.fengyl.eta.ui.model.ConversationPaneUiState
import io.github.fengyl.eta.ui.model.ConversationSummaryUi
import io.github.fengyl.eta.ui.model.MessageEditUiState
import io.github.fengyl.eta.ui.model.PendingFileReferenceUi
import io.github.fengyl.eta.ui.model.PendingImageUi
import io.github.fengyl.eta.ui.model.PermissionHealthItemUi
import io.github.fengyl.eta.ui.model.PermissionHealthUiState
import io.github.fengyl.eta.ui.model.PermissionStatusUi
import io.github.fengyl.eta.ui.model.SkillItemUi
import io.github.fengyl.eta.ui.model.SkillNoticeUi
import io.github.fengyl.eta.ui.model.SkillReplacementUi
import io.github.fengyl.eta.ui.model.SystemNoticeCode
import io.github.fengyl.eta.ui.model.SystemNoticeMessageUi
import io.github.fengyl.eta.ui.model.ThinkingMessageUi
import io.github.fengyl.eta.ui.model.TokenUsageUi
import io.github.fengyl.eta.ui.model.ToolActivityMessageUi
import io.github.fengyl.eta.ui.model.ToolGroupUi
import io.github.fengyl.eta.ui.model.ToolItemUi
import io.github.fengyl.eta.ui.model.UserMessageUi
import io.github.fengyl.eta.ui.model.canDeleteUserSkill
import io.github.fengyl.eta.ui.model.contentMatches
...
private fun buildPermissionHealthState(context: Context): PermissionHealthUiState {
    ...
    val notificationHistoryEnabled = io.github.fengyl.eta.agent.device.AgentNotificationHistoryService.isEnabled(context)
    val usageAccessEnabled = io.github.fengyl.eta.agent.tool.AgentPersonalContextTools.hasUsageAccess(context)
