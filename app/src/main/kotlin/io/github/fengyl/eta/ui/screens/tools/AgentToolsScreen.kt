package io.github.fengyl.eta.ui.screens.tools
...
import io.github.fengyl.eta.ui.model.projectToolGroups
            ...
            EtaPreferenceGroup(modifier = Modifier.padding(horizontal = 16.dp).padding(bottom = 8.dp)) {
                EtaArrowPreference(
                    ...
                    onClick = { context.startActivity(android.content.Intent(context,
                        io.github.fengyl.eta.agent.display.WorkDisplayActivity::class.java)) },
                )
                EtaArrowPreference(
