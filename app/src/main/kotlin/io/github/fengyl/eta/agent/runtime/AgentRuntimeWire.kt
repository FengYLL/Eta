...
import io.github.fengyl.eta.agent.model.AssistantScreenContextProjection
...
import io.github.fengyl.eta.data.model.CustomBody
import io.github.fengyl.eta.data.model.CustomHeader
...
internal object AgentRuntimeWire {
    ...
    const val ACTION_BIND = "io.github.fengyl.eta.agent.runtime.BIND"
    ...
    private const val MODULE_PACKAGE = "io.github.fengyl.eta"
    private const val SERVICE_CLASS = "io.github.fengyl.eta.agent.runtime.AgentRuntimeService"
        ...
        readText: Boolean,
            ...
            config = AgentModelClient.ModelConfig(
                ...
                providerType = bundle.getString(KEY_PROVIDER_TYPE).orEmpty()
                    .ifBlank { io.github.fengyl.eta.data.model.ProviderTypes.OPENAI_COMPATIBLE },
                ...
                anthropicVersion = bundle.getString(KEY_ANTHROPIC_VERSION).orEmpty()
                    .ifBlank { io.github.fengyl.eta.data.model.AnthropicProviderSetting.DEFAULT_ANTHROPIC_VERSION },
                openAiEndpointMode = bundle.getString(KEY_OPENAI_ENDPOINT_MODE).orEmpty()
                    .ifBlank { io.github.fengyl.eta.data.model.OpenAiEndpointMode.CHAT_COMPLETIONS },
